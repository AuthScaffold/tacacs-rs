//! Mock transport for integration-testing [`TacacsConnection`] without a real network.
//!
//! # Overview
//!
...
//! reply packets, hand the transport to [`TacacsConnection::run`], and afterwards
...
//!  │  4. Pass MockTransport to TacacsConnection::run()               │
...
//! | Type | Role |
//! |------|------|
//! | [`MockTransport`] | Created by tests, passed to `TacacsConnection::run()`. |
...
//! [`TacacsConnection`]: crate::connection::TacacsConnection
