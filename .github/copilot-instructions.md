...
- **Applications** (`tacon`, `tacacsrs-agentd`) use **CalVer** `YYYY.MMDD.BUILD` (e.g. `2026.416.0`), where MMDD = month×100+day and BUILD is a zero-based same-day counter. CalVer tags are created automatically when changes land on `main`.
